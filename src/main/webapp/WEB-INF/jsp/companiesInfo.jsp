                ...
                <div class="panel panel-default">
		                <div class="panel-heading">
		                    <div class="form-group">
		                        ...
		                        <div class="row">
			                        <form:form modelAttribute="companyInfo" action="${pageContext.request.contextPath}/companiesInfo" method="POST">
		                            ...
		                            <tr>
		                                ...
		                                <tbody>
		                                	<c:forEach var="companyInfo" items="${companiesInfo }">
		                                	    <tr class="gradeA">
		                                            <td><a href="${pageContext.request.contextPath}/companyInfo/${companyInfo.companyId}">${companyInfo.companyId}</a></td>
		                                            <td><a href="${pageContext.request.contextPath}/companyInfo/${companyInfo.companyId}">${companyInfo.name}</a></td>
